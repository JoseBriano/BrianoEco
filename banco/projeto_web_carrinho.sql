...
CREATE TABLE `carrinho` (
  ...
  `descricao_carrinho` text DEFAULT NULL,
  ...
  CONSTRAINT `carrinho_ibfk_1` FOREIGN KEY (`idProdutos`) REFERENCES `produtos` (`idProdutos`)
...
-- Dump completed on 2024-04-16 16:49:53

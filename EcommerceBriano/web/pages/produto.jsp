        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="./lancamentos"><i class="fa-solid fa-rocket"></i> Lançamentos</a>
            </div>
          </li>
          <li class="nav-item">
      ...
      <div class="container">
        <c:forEach items="${produto}" var="produtos">
            <div id="produto_${produtos.idProdutos}" class="produto">
                ...
                <button type="submit" class="btn btn-comprar"  data-id="${produtos.idProdutos}" data-descricao="${produtos.descricao}" data-nome="${produtos.nome}" data-preco="${produtos.preco}" data-imagem="${produtos.imagemBase64}"
